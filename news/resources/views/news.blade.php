...
<main>
  ...
  <div id="carouselPrincipal" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      @foreach($ultimasNoticias as $noticia)
      <div class="carousel-item {{$loop->index==0?'active':''}} ratio" style="--bs-aspect-ratio: 20%;">
        <img src="/storage/imagens/{{$noticia->figura}}" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5><a href="news/{{$noticia->id}}">{{$noticia->titulo}}</a></h5>
